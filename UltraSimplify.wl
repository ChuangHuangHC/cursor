...
(* ::Package:: *)
(* UltraSimplify: group by denominator \[RightArrow] Simplify each \[RightArrow] Sum \[RightArrow] Simplify *)
...
GroupTermsByDenominator::timeout = "\:8d85\:65f6 `1` \:79d2\:ff0c\:8bf7\:52a0\:5927 TimeLimit\:3002";
...
UltraSimplify[expr_, opts : OptionsPattern[]] :=
  Module[{grouped, parts},
   ...
   parts = Table[
     Simplify[grouped[[i, 2]], TimeConstraint -> Infinity],
     {i, Length[grouped]}
     ];
   Simplify[Total[parts], TimeConstraint -> Infinity]
   ];
