(* Kinematics:
     p1 = {p,0,0,0} = -p3
     p2 = {0,p,0,0} = -p4
   CMA: unordered legs, overall minus identified.
   Collapsed QFs (RHS kept, LHS dropped):
     lambdacca  QF5,6,7 -> QF2,1,1;  QF8 -> QF4
     lambda4a   QF10 -> QF9;  QF14 -> QF13;  QF23 -> QF12
     lambda3a   QF18,30 -> QF17;  QF24,47 -> QF21;
                QF27,31 -> QF15;  QF28 -> QF19;  QF32 -> QF29;  QF49 -> QF48
     lambdaqqa  QF37 -> QF34;  QF38,39 -> QF33;  QF40 -> QF36
*)
...
dlambda4A1 = dlambda4A /. paraRepl4 /. {
     ...
     (*dLambda4Aq  QF37=QF34, QF38=QF33*)
     lambdaqqa1[-p1 - q, q, p1] -> lambdaqqa1QF33,
     lambdaqqa4[-p1 - q, q, p1] -> lambdaqqa4QF33,
     lambdaqqa7[-p1 - q, q, p1] -> lambdaqqa7QF33,
     lambdaqqa1[-q, -p2 + q, p2] -> lambdaqqa1QF34,
     ...
     (*dLambda4Ar  QF39=QF33, QF40=QF36*)
     lambdaqqa1[-p1 - q, q, p1] -> lambdaqqa1QF33,
     lambdaqqa4[-p1 - q, q, p1] -> lambdaqqa4QF33,
     lambdaqqa7[-p1 - q, q, p1] -> lambdaqqa7QF33,
